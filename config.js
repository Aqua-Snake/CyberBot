...
module.exports = {
    ...
    PASS: process.env.BOT_PASSWORD === undefined ? false : process.env.BOT_PASSWORD,
    ...
    YAK: process.env.YAK === undefined ? '94701807103,0' : process.env.YAK,
    ...
    OWN3: process.env.OWN3 === undefined ? '94740387449,0' : process.env.OWN3,
    OWN4: process.env.OWN4 === undefined ? '94778238016,0' : process.env.OWN4,
    OWN5: process.env.OWN5 === undefined ? '94775893620,0' : process.env.OWN5,
    OWN6: process.env.OWN6 === undefined ? '94781171093,0' : process.env.OWN6,
    OWN7: process.env.OWN7 === undefined ? '12156667883,0' : process.env.OWN7,
    BRANCH: 'master',
    HEROKU: {
