...
module.exports = {
    ...
    AFN: process.env.ALL_CAPTION === undefined ? '*ᴍᴀᴅᴇ ʙʏ ᴄʏʙᴇʀ ʙᴏᴛ|©*' : process.env.ALL_CAPTION,
    ...
    BOT1: process.env.BOT_NAMES === undefined ? 'ᴄʏʙᴇʀ ʙᴏᴛ|©' : process.env.BOT_NAMES,
    ...
    TALKING_CHATBOT: process.env.TALKING_CHATBOT === undefined ? 'false' : process.env.TALKING_CHATBOT,
    ...
    KTB: process.env.TAG_HEADER === undefined ? 'Attention Please' : process.env.TAG_HEADER,
