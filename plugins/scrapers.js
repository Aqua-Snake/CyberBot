...
let td = config.WORKTYPE == 'public' ? false : true
    ...
    Asena.addCommand({pattern: 'detectlang$', fromMe: td, desc: dlang_dsc}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'currency(?: ([0-9.]+) ([a-zA-Z]+) ([a-zA-Z]+)|$|(.*))', fromMe: td}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'song ?(.*)', fromMe: td, desc: Lang.SONG_DESC}, (async (message, match) => { 
    ...
    Asena.addCommand({pattern: 'video ?(.*)', fromMe: td, desc: Lang.VIDEO_DESC}, (async (message, match) => { 
        ...
        yt.on('end', async () => {
            ...
            await message.client.sendMessage(message.jid,fs.readFileSync('./' + VID + '.mp4'), MessageType.video, { quoted: message.data, caption: "*ᴍᴀᴅᴇ ʙʏ ᴡʜɪᴛᴇ ᴅᴇᴠɪʟ*" });
        });
    }));

    Asena.addCommand({pattern: 'sing ?(.*)', fromMe: td, desc: Lang.SING_DESC}, (async (message, match) => { 
    ...
    Asena.addCommand({pattern: 'song ?(.*)', fromMe: td, desc: Lang.ISONG_DESC}, (async (message, match) => { 
        ...
        ffmpeg(stream)
            ...
            .on('end', async () => {
                ...
                await message.client.sendMessage(message.jid,Buffer.from(writer.arrayBuffer), MessageType.document, {filename: 'for iphone ᴍᴀᴅᴇ ʙʏ ᴡʜɪᴛᴇ ᴅᴇᴠɪʟ' + '.mp3', mimetype: 'audio/mpeg', quoted: message.data});
            });
    }));


    Asena.addCommand({pattern: 'wiki ?(.*)', fromMe: td, desc: Lang.WIKI_DESC}, (async (message, match) => { 
    ...
    Asena.addCommand({pattern: 'img ?(.*)', fromMe: td, desc: Lang.IMG_DESC}, (async (message, match) => { 
...
thumbnail: White.tm_b});
    ...
    Asena.addCommand({ pattern: 'github ?(.*)', fromMe: td, desc: Glang.GİTHUB_DESC }, async (message, match) => {
    ...
    Asena.addCommand({pattern: 'lyric ?(.*)', fromMe: td, desc: Slang.LY_DESC }, (async (message, match) => {
    ...
    Asena.addCommand({pattern: "covid ?(.*)", fromMe: td, desc: Clang.COV_DESC}, (async (message, match) => {
        if (match[1] === "") {
            try{
